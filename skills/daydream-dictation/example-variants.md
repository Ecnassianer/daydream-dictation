...
This file shows the format for listing words your voice dictation software commonly confuses. Create your own file at `.claude/dd-voice-variants.md` in your repository root. Claude will check it during dictation sessions and silently substitute the correct word when it sees a listed variant.
